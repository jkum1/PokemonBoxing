...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes } = useGLTF('/pokemonGLB/Ponyta.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh castShadow geometry={nodes.polygon4.geometry} material={nodes.polygon4.material} scale={[2,2,2]}/>
    </group>
  )
}

useGLTF.preload('/pokemonGLB/Ponyta.glb')
